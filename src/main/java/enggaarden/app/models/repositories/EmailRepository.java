...
public class EmailRepository implements EmailRepositoryInterface
{
    ...
    {
        String emails = "";
        String sql = "SELECT DISTINCT mail FROM members WHERE memberType = 'Primær'" +
    ...
    {
        String emails = "";
        String sql = "SELECT DISTINCT mail FROM members WHERE memberType = 'Sekundær'" +
                     " AND CHAR_LENGTH(mail) > 0 AND mail IS NOT NULL;";
    ...
    {
        String emails = "";
        String sql = "SELECT DISTINCT mail FROM members WHERE memberType = 'Ekstern'" +
                     " AND CHAR_LENGTH(mail) > 0 AND mail IS NOT NULL;";
    ...
    {
        String emails = "";
        String sql = "SELECT DISTINCT mail FROM members WHERE CHAR_LENGTH(mail) > 0 AND mail IS NOT NULL;";
    ...
    {
        String emails = "";
        String sql = "SELECT DISTINCT mail FROM members WHERE " +
